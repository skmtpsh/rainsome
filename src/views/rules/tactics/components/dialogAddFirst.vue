<template>
  <el-dialog
    ...
    <el-form ref="form" :model="form" :rules="rules" label-width="100px">
      <el-form-item label="策略名称" prop="strgyName">
        <el-input v-model="form.strgyName" placeholder="请输入策略集名称" style="width:100%"></el-input>
      </el-form-item>
      <el-row :gutter="10">
        <el-col :span="14">
          <el-form-item label="应用产品" prop="firstProductCode">
            <el-select
              :disabled="!!row.id"
              style="width:100%"
              v-model="form.firstProductCode"
              filterable
              remote
              reserve-keyword
              placeholder="请输入名称"
        ...
        <el-col :span="10">
          <el-form-item class="inlineFormItem" prop="secondProductCode">
              <el-select
                :disabled="!!row.id"
                style="width:100%"
                v-model="form.secondProductCode"
                filterable
                remote
                reserve-keyword
                placeholder="请输入名称"
      ...
      <el-row :gutter="10">
        <el-col :span="14">
          <el-form-item label="应用客群" prop="custTypeCode">
            <el-select
              :disabled="!!row.id"
              style="width:100%"
              v-model="form.custTypeCode"
              filterable
              remote
              reserve-keyword
              placeholder="请输入名称"
        ...
        <el-col :span="10">
          <el-form-item class="inlineFormItem" prop="custBehaviorCode">
              <el-select
                :disabled="!!row.id"
                style="width:100%"
                v-model="form.custBehaviorCode"
                filterable
                remote
                reserve-keyword
                placeholder="请输入名称"
      ...
      <el-form-item label="风险决策" prop="strategyMode">
        <el-select
          :disabled="!!row.id"
          style="width:48%"
          v-model="form.strategyMode"
          filterable
          reserve-keyword
          placeholder="请输入名称">
          <el-option
      ...
      <el-form-item label="规则用途" prop="releaseType">
        <el-select
          :disabled="!!row.id"
          style="width:48%"
