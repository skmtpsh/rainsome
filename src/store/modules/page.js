...
console.log('==========setting.page.opened')
console.log(setting.page.opened)
// import router from '@/router'
...
export default {
      ...
      return new Promise(async resolve => {
        ...
        state.opened = value.map(opened => {
          ...
          const find = state.pool.find(item => {
            console.log(item)
            console.log(item.name === opened.name)
    ...
    open ({ state, commit, dispatch }, { name, params, query, fullPath }) {
      return new Promise(async resolve => {
        ...
        const pageOpend = opened.find((page, index) => {
          console.log('@@@@@@@page.fullPath === fullPath@@@@@@@@')
          console.log(page.fullPath, fullPath)
  ...
  mutations: {
    ...
    keepAliveRemove (state, name) {
      ...
      console.log('=========state.keepAliveRemove')
      console.log(list)
      if (index !== -1) {
        list.splice(index, 1)
    ...
    keepAlivePush (state, name) {
      ...
      keep.push(name)
      console.log('=========state.keepAlivePush')
      console.log(keep)
    ...
    currentSet (state, { fullPath, params, query }) {
      ...
      console.log(state.current, state.params, params)
    },
    /**
     * @class pool
